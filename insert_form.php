...
<tr><td align=right><label>หลักสูตร  : </td>
		<td><input type="radio" name="pro_status" value=" 4 ปี" id="pro_status_0">  4 ปี</td></tr></label>
		<tr><td><label></td><td><input type="radio" name="pro_status" value=" เทียบโอนปกติ" id="pro_status_1"> เทียบโอนปกติ </label></td></tr>
		<tr><td><label></td><td><input type="radio" name="pro_status" value="เทียบโอนสมทบ" id="pro_status_3"> เทียบโอนสมทบ </label></td></tr>
	<tr><td><b></td><td></td></tr>
	<tr><td><b></td>
