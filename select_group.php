...
//query
$query=mysqli_query($conn,"SELECT COUNT(name_g) FROM groupp WHERE name_g LIKE '%$search%'");
...
<html>
	...
	<div rel = "nofollow">
			...
			<div class = "row">
				...
				<font size="4"><center><b><u>ตารางข้อมูลกลุ่มเรียน</b></u></center></font>
				</table>
					<table class="table table-striped table-bordered table-hover">
						<thead>
							<tr class="info" >
                            <th><center>ชื่อกลุ่มเรียน</th>
							<th><center>หลักสูตร</th>
						...
						<tbody>
							...
							?>
							<tr>
								<td><center><?php echo $crow['name_g']; ?></td>
								<td><?php echo $crow['status_g']; ?></td>
								<td><center><?php echo "<a href='update_group.php?ID_group=".$crow['ID_group']."'><img src='edit.png' width='20px' height='20px'></a></td></a>"; ?></td>
								<td><center><?php echo "<a href='delete.php?ID_group=".$crow['ID_group']."' onclick='return confirm(\"คุณต้องการที่จะลบข้อมูลนี้หรือไม่ ?\")'><img src='delete.png' width='20px' height='20px'></a></td></a>"; ?></td>
							</tr>
							<?php
							$i++;
									}
...
<!-- Ref : 
	...
	-->
	<a href="insert_group.php"><center>เพิ่มข้อมูล</center></a>